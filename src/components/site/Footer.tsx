      ...
      <div className="container-x py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/modelos/urba" className="text-white/70 hover:text-white">URBA</Link></li>
            <li><Link to="/modelos/move" className="text-white/70 hover:text-white">MOVE</Link></li>
          </ul>
        </div>
        <div>
