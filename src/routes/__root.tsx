  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Não conseguimos carregar essa página. Tente novamente ou volte para a home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "PISONI" },
      { property: "og:title", content: "PISONI — Mobilidade elétrica premium" },
      { property: "og:description", content: "Scooters e motos elétricas PISONI: design autoral, tecnologia silenciosa, presença urbana." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_BR" },
      { property: "og:site_name", content: "PISONI" },
      ...
      { property: "og:image:alt", content: "PISONI — Mobilidade elétrica premium" },
