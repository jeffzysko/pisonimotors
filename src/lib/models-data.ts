...
export const MODELS: Record<"urba" | "move", ModelData> = {
  urba: {
    ...
    specs: [
      ...
      { label: "Painel", value: "LCD com Bluetooth" },
      { label: "Categoria", value: "Ciclomotor" },
    ],
    design: [
  ...
  move: {
    ...
    specs: [
      ...
      { label: "Painel", value: "TFT com app conectado" },
      { label: "Categoria", value: "Motocicleta elétrica (CNH A)" },
    ],
    design: [
